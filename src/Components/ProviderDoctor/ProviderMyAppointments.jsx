    ...
    <div className="container my-4">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-white py-3">
          <h2 
            className={`text-center mb-0 ${animateHeader ? 'animate__animated animate__pulse' : ''}`} 
            style={{ color: '#F95918' }}
          >
            <i className="fas fa-calendar-check me-2"></i>
            My Appointments
          </h2>
          <p className="text-muted text-center mb-0">Manage your patient appointments and consultations</p>
        </div>
