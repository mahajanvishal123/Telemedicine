        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl p-12 shadow-lg">
            <p className="text-xl text-gray-700 text-center leading-relaxed max-w-4xl mx-auto">
              Our mission is simple: to provide trusted, inclusive, and accessible healthcare solutions worldwide. 
              We leverage AI, blockchain verification, and human-centered design to make quality healthcare a 
